...
export default function P0Dashboard() {
  ...
  if (error) {
    // Sprint 1: Show dashboard even with partial errors (some endpoints may be under development)
    // Fall through to show what we have rather than blocking the entire dashboard
  }
