...
class PerformanceMetrics:
    ...
    # Trade-Based Metrics (S1.4B Extended)
    profit_factor: float = 0.0          # Gross profit / Gross loss
    expectancy: float = 0.0             # Expected value per trade
    avg_trade_return: float = 0.0       # Average PnL per trade
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            # Trade-Based Metrics
            "profit_factor": round(self.profit_factor, 4) if self.profit_factor != float('inf') else "Infinity",
